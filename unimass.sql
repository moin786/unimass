...
--
<<<<<<< HEAD
CREATE PROCEDURE `proc_getsalesagentauto` (IN `in_category_pk_no` BIGINT, IN `in_area_pk_no` BIGINT)  BEGIN
=======
CREATE  PROCEDURE `proc_getsalesagentauto` (IN `in_category_pk_no` BIGINT, IN `in_area_pk_no` BIGINT)  BEGIN
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `proc_getsalesagentauto_ind` (IN `in_category_pk_no` BIGINT, IN `in_area_pk_no` BIGINT)  BEGIN
=======
CREATE  PROCEDURE `proc_getsalesagentauto_ind` (IN `in_category_pk_no` BIGINT, IN `in_area_pk_no` BIGINT)  BEGIN
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `proc_getsalesagentauto_ind_5d` (IN `in_category_pk_no` BIGINT, IN `in_area_pk_no` BIGINT, OUT `out_user_pk_no` BIGINT)  BEGIN
=======
CREATE  PROCEDURE `proc_getsalesagentauto_ind_5d` (IN `in_category_pk_no` BIGINT, IN `in_area_pk_no` BIGINT, OUT `out_user_pk_no` BIGINT)  BEGIN
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `proc_leadlifecycle_upd_stage` (IN `in_lead_pk_no` BIGINT, IN `in_datetime` DATE, IN `in_by` BIGINT, IN `in_tostage` INT, IN `in_c_pk_no_created` BIGINT, IN `in_flat_id` BIGINT)  BEGIN 
=======
CREATE  PROCEDURE `proc_leadlifecycle_upd_stage` (IN `in_lead_pk_no` BIGINT, IN `in_datetime` DATE, IN `in_by` BIGINT, IN `in_tostage` INT, IN `in_c_pk_no_created` BIGINT, IN `in_flat_id` BIGINT)  BEGIN 
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `proc_leadtransfer_ins` (IN `in_lead_transfer_id` VARCHAR(30), IN `in_transfer_datetime` DATE, IN `in_lead_pk_no` BIGINT, IN `in_transfer_from_sales_agent_pk_no` BIGINT, IN `in_transfer_to_sales_agent_pk_no` BIGINT, IN `in_transfer_to_sales_agent_flag` INT, IN `in_re_transfer` INT, IN `in_ch_user_pk_no` BIGINT, IN `in_c_pk_no_created` BIGINT, IN `in_created_by` BIGINT, IN `in_created_at` DATE)  BEGIN 
=======
CREATE  PROCEDURE `proc_leadtransfer_ins` (IN `in_lead_transfer_id` VARCHAR(30), IN `in_transfer_datetime` DATE, IN `in_lead_pk_no` BIGINT, IN `in_transfer_from_sales_agent_pk_no` BIGINT, IN `in_transfer_to_sales_agent_pk_no` BIGINT, IN `in_transfer_to_sales_agent_flag` INT, IN `in_re_transfer` INT, IN `in_ch_user_pk_no` BIGINT, IN `in_c_pk_no_created` BIGINT, IN `in_created_by` BIGINT, IN `in_created_at` DATE)  BEGIN 
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `proc_lookdata_ins` (IN `in_lookup_type` VARCHAR(30), IN `in_lookup_id` VARCHAR(30), IN `in_lookup_name` VARCHAR(200), IN `in_lookup_row_status` INT, IN `in_c_pk_no_created` BIGINT, IN `in_created_by` BIGINT, IN `in_created_at` DATE)  BEGIN 
=======
CREATE  PROCEDURE `proc_lookdata_ins` (IN `in_lookup_type` VARCHAR(30), IN `in_lookup_id` VARCHAR(30), IN `in_lookup_name` VARCHAR(200), IN `in_lookup_row_status` INT, IN `in_c_pk_no_created` BIGINT, IN `in_created_by` BIGINT, IN `in_created_at` DATE)  BEGIN 
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `proc_setunattended_lead` ()  BEGIN
=======
CREATE  PROCEDURE `proc_setunattended_lead` ()  BEGIN
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `run_sys_procgenerate` ()  begin
=======
CREATE  PROCEDURE `run_sys_procgenerate` ()  begin
>>>>>>> master
...
<<<<<<< HEAD
CREATE PROCEDURE `sys_procgenerate` (IN `in_tabname` VARCHAR(30), IN `in_procname` VARCHAR(30))  BEGIN
=======
CREATE  PROCEDURE `sys_procgenerate` (IN `in_tabname` VARCHAR(30), IN `in_procname` VARCHAR(30))  BEGIN
>>>>>>> master
DECLARE finished INTEGER DEFAULT 0;
