...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2021 at 03:41 PM
...
CREATE TABLE `project_schedule_collectoins` (
  ...
  `bank_lookup_id` int(10) DEFAULT NULL,
  `check_no` text DEFAULT NULL,
  `cheque_date` date DEFAULT NULL,
  `received_date` date DEFAULT NULL,
  `mr_no` int(11) DEFAULT NULL,
  `remarks` text DEFAULT NULL,
  `is_schedule_penalty` tinyint(2) DEFAULT NULL,
  `collect_by` int(10) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `project_schedule_collectoins`
--

INSERT INTO `project_schedule_collectoins` (`id`, `schedule_id`, `lead_pk_no`, `lead_id`, `collected_amount`, `bank_lookup_id`, `check_no`, `cheque_date`, `received_date`, `mr_no`, `remarks`, `is_schedule_penalty`, `collect_by`, `created_at`, `updated_at`) VALUES
(1, 1, 6, 'L202136', '6180000.00', 779, '4564564', '2021-03-10', '2021-03-15', 343, NULL, 0, 338, '2021-01-10 09:13:43', '2021-03-10 09:13:43'),
(2, 1, 6, 'L202136', '15450.00', 779, '4564564', '2021-03-10', '2021-03-15', 343, 'On due penalty', 1, 338, '2021-03-10 09:13:44', '2021-03-10 09:13:44'),
(3, 2, 6, 'L202136', '3020000.00', 779, '4564564', '2021-03-10', '2021-03-15', 343, NULL, 0, 338, '2021-02-10 09:13:44', '2021-03-10 09:13:44'),
(4, 2, 6, 'L202136', '11587.00', 779, '4564564', '2021-03-10', '2021-03-15', 343, 'On due penalty', 1, 338, '2021-03-10 09:13:44', '2021-03-10 09:13:44'),
(5, 2, 6, 'L202136', '700000.00', 780, '675675', '2021-03-11', '2021-03-11', 444, NULL, 0, 338, '2021-03-11 13:52:41', '2021-03-11 13:52:41'),
(6, 2, 6, 'L202136', '10300.00', 780, '675675', '2021-03-11', '2021-03-11', 444, 'On due penalty', 1, 338, '2021-03-11 13:52:41', '2021-03-11 13:52:41'),
(7, 2, 6, 'L202136', '893113.00', 780, '787989', '2021-04-10', '2021-04-21', 3434, NULL, 0, 338, '2021-04-11 14:05:30', '2021-03-11 14:05:30'),
(8, 2, 6, 'L202136', '10300.00', 780, '787989', '2021-04-10', '2021-04-21', 3434, 'On due penalty', 1, 338, '2021-04-11 14:05:30', '2021-03-11 14:05:30'),
(9, 3, 6, 'L202136', '1200000.00', 780, '889999', '2021-06-16', '2021-04-20', 9999, NULL, 0, 338, '2021-03-11 14:08:41', '2021-03-11 14:08:41'),
(10, 3, 6, 'L202136', '5150.00', 780, '889999', '2021-06-16', '2021-04-20', 9999, 'On due penalty', 1, 338, '2021-03-11 14:08:41', '2021-03-11 14:08:41');

-- --------------------------------------------------------

--
-- Table structure for table `schedule_followup`
--

CREATE TABLE `schedule_followup` (
  `id` int(11) NOT NULL,
  ...
  `is_meeting_done` int(11) DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
...
(1, 6, 'L202136', '2021-03-01', 'Part of booking money', 6180000.00, 40.00, 'Completed', '2021-03-10 09:10:23', '2021-03-10 09:13:44'),
(2, 6, 'L202136', '2021-03-03', 'Part of booking money', 4635000.00, 30.00, 'Completed', '2021-03-10 09:10:23', '2021-03-11 14:05:30'),
(3, 6, 'L202136', '2021-03-05', '1st installment', 3090000.00, 20.00, 'In Complete', '2021-03-10 09:10:23', '2021-03-10 09:10:23'),
(4, 6, 'L202136', '2021-03-06', '2nd installment', 1545000.00, 10.00, 'In Complete', '2021-03-10 09:10:23', '2021-03-10 09:10:23');
...
(73, '1', '1', 'GM(HOD)', 1, 1, 1, '2020-01-04', NULL, '2021-03-04', NULL),
...
(783, '25', '1', '24', 1, 1, 1, '2021-03-09', NULL, '2021-03-09', NULL),
(607, '29', '2', 'Walk In', 1, 1, 1, '2020-11-30', NULL, NULL, NULL),
(782, '18', '1', 'CR & SALES', 1, 1, 1, '2021-03-04', NULL, NULL, NULL),
...
(779, '30', '1', 'Islami Bank Ltd.', 1, 1, 1, '2021-03-02', NULL, NULL, NULL),
(780, '30', '1', 'Dhaka Bank', 1, 1, 1, '2021-03-02', NULL, NULL, NULL),
(781, '30', '1', 'City Bank', 1, 1, 1, '2021-03-02', NULL, NULL, NULL),
(784, '25', '1', '24', 1, 1, 1, '2021-03-09', NULL, NULL, NULL),
(785, '25', '1', '24', 1, 1, 1, '2021-03-09', NULL, NULL, NULL),
(786, '25', '1', '24', 1, 1, 1, '2021-03-09', NULL, NULL, NULL),
(787, '25', '1', '24', 1, 1, 1, '2021-03-09', NULL, '2021-03-09', NULL),
(788, '31', '1', '10', 1, 1, 1, '2021-03-09', NULL, '2021-03-09', NULL);
...
(26, 'Schedule Collection', 'schedule-collection', 1, NULL, NULL, NULL, NULL, 2),
(27, 'Pending Collection', 'pending-collection', 1, NULL, NULL, NULL, NULL, 2),
(28, 'SMS Campaign List', 'sms_campaign_list', 1, NULL, NULL, NULL, NULL, 6),
(29, 'Send SMS', 'send-SMS', 1, NULL, NULL, NULL, NULL, 6);
...
(1, 746, NULL, 'A-6', 583, 758, 597, ' ', NULL, NULL, NULL, NULL, 1, 0, NULL, 1, '2021-02-06', NULL, '2021-03-09', NULL),
(2, 746, NULL, 'A-7', 583, 758, 597, ' ', NULL, NULL, NULL, NULL, 1, 0, NULL, 1, '2021-02-06', NULL, '2021-03-10', NULL),
(3, 746, NULL, 'A-8', 583, 758, 597, ' ', NULL, NULL, NULL, NULL, 0, 0, NULL, 1, '2021-02-06', NULL, '2021-02-06', NULL),
(4, 746, NULL, 'C-9', 583, 758, 598, ' ', NULL, NULL, NULL, NULL, 1, 0, NULL, 1, '2021-02-06', NULL, '2021-03-04', NULL),
...
(17, 749, NULL, 'A-2', 583, 760, 599, ' ', NULL, NULL, NULL, NULL, 1, 0, NULL, 1, '2021-02-06', NULL, '2021-03-10', NULL),
...
(41, 755, NULL, 'A-2', 583, 764, 598, ' ', NULL, NULL, NULL, NULL, 1, 0, NULL, 1, '2021-02-06', NULL, '2021-03-08', NULL),
(42, 755, NULL, 'A-4', 583, 764, 598, ' ', NULL, NULL, NULL, NULL, 0, 0, NULL, 1, '2021-02-06', NULL, '2021-02-06', NULL),
(43, 755, NULL, 'A-6', 583, 764, 598, ' ', NULL, NULL, NULL, NULL, 1, 0, NULL, 1, '2021-02-06', NULL, '2021-03-08', NULL),
...
(59, 749, NULL, 'A1', 583, 555, 562, ' ', 123323232, 123323232, 50, 123323232, 1, 0, NULL, 1, '2021-02-28', NULL, '2021-02-28', NULL);
...
(150, 775, 12, 1, NULL, '2021-02-28', NULL, '2021-02-28'),
(151, 775, 26, 1, NULL, '2021-02-28', NULL, '2021-02-28'),
(152, 775, 27, 1, NULL, '2021-03-10', NULL, '2021-03-10'),
(153, 1, 28, 1, NULL, NULL, NULL, NULL),
(154, 1, 29, 1, NULL, NULL, NULL, NULL);
...
(315, 338, 'CSD', 'CSD', '', 775, 'csd@app.com', '015285287587', NULL, NULL, NULL, 'CSD', '0141274574', 1, NULL, NULL, '2021-02-28', NULL, '2021-02-28', NULL, NULL, NULL, 3, NULL, 0, NULL);
...
(1, '1', 1, ' ', 0, NULL, 305, '2021-03-05', 312, '2021-03-05', 1, 0, NULL, 0, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 310, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 305, '2021-03-05', 1, '2021-03-05', NULL, NULL),
(2, '1', 2, ' ', 0, NULL, 305, '2021-03-05', 309, '2021-03-05', 1, 0, NULL, 0, 1, '2021-03-05', 309, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 309, '2021-03-05', NULL, '2021-03-05', NULL, NULL),
(3, '1', 3, ' ', 0, NULL, 305, '2021-03-05', 311, '2021-03-10', 1, 0, NULL, 0, 1, '2021-03-05', 311, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 17, NULL, NULL, '2021-03-10', 15000000, 150000, 150000, NULL, 'Done', NULL, 150000, 311, 1, 1, 1, 305, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 311, '2021-03-05', NULL, '2021-03-10', NULL, NULL),
(4, '1', 4, ' ', 0, NULL, 305, '2021-03-05', 312, '2021-03-05', 1, 0, NULL, 0, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 305, '2021-03-05', 1, '2021-03-05', NULL, NULL),
(5, '1', 5, ' ', 0, NULL, 305, '2021-03-05', 310, '2021-03-05', 1, 0, NULL, 0, 1, '2021-03-05', 312, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 43, NULL, NULL, '2021-03-08', 15000000, 150000, 150000, NULL, '0', NULL, 150000, 310, 1, 1, 1, 305, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 312, '2021-03-05', NULL, '2021-03-08', NULL, NULL),
(6, '1', 6, ' ', 1, 309, 305, '2021-03-05', 310, '2021-03-06', 7, 0, NULL, 0, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, NULL, NULL, '2021-03-10', 15000000, 150000, 150000, NULL, 'Done', NULL, 150000, 310, 1, 1, 1, 305, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 305, '2021-03-05', 1, '2021-03-10', NULL, NULL);
...
(1, 'L202131', 'Ruhul', 'Alam', '', '', '880', '1716187302', NULL, '880', '', 'ruhul@gmail.com', 2, '', '', '', '', 0, 0, 0, '', '', '', 0, 0, 0, '', '', 0, 0, 0, 583, 758, 746, 597, 305, 73, '', '', '', '616', '', '', 0, '', '', 0, 1, '0000-01-01', '0000-01-01', '', '0000-01-01', '0000-01-01', '', '0000-01-01', '', '0000-01-01', '', '0000-01-01', 0, '0000-01-01', '2021-03-05 19:30:00', '', '', '', '', '', '', '', '', '', '', 1, 305, '2021-03-05 19:23:50', NULL, NULL, NULL),
(2, 'L202132', 'Arif', 'Hasan', '', '', '880', '1716176345', NULL, '880', '', 'arif@gmail.com', 2, '', '', '', '', 0, 0, 0, '', '', '', 0, 0, 0, '', '', 0, 0, 0, 583, 761, 750, 598, 309, 77, '', '', '', '535', '', '', 0, '', '', 0, 1, '0000-01-01', '0000-01-01', '', '0000-01-01', '0000-01-01', '', '0000-01-01', '', '0000-01-01', '', '0000-01-01', 0, '0000-01-01', '2021-03-05 19:45:00', '', '', '', '', '', '', '', '', '', '', 1, 309, '2021-03-05 19:40:49', NULL, NULL, NULL),
(3, 'L202133', 'Imran', 'Hasan', '', '', '880', '1716143677', NULL, '880', '', 'imran@gmail.com', 3, '', '', '', '', 0, 0, 0, '', '', '', 0, 0, 0, '', '', 0, 0, 0, 583, 555, 749, 599, 311, 77, '', '', '', '536', '', '', 0, '', '', 0, 1, '0000-01-01', '0000-01-01', '', '0000-01-01', '0000-01-01', '', '0000-01-01', '', '0000-01-01', '', '0000-01-01', 0, '0000-01-01', '2021-03-05 19:45:00', '', '', '', '', '', '', '', '', '', '', 1, 311, '2021-03-05 19:45:32', NULL, '2021-03-10', NULL),
(4, 'L202134', 'Rehana', 'Akter', '', '', '880', '1716543765', NULL, '880', '', 'rehana@gmail.com', 3, '', '', '', '', 0, 0, 0, '', '', '', 0, 0, 0, '', '', 0, 0, 0, 583, 758, 747, 598, 305, 73, '', '', '', '112', '', '', 0, '', '', 0, 1, '0000-01-01', '0000-01-01', '', '0000-01-01', '0000-01-01', '', '0000-01-01', '', '0000-01-01', '', '0000-01-01', 0, '0000-01-01', '2021-03-05 20:00:00', '', '', '', '', '', '', '', '', '', '', 1, 305, '2021-03-05 19:51:38', NULL, NULL, NULL),
(5, 'L202135', 'Dulal', 'Uddin', '', '', '880', '1716554433', NULL, '880', '', 'dulal@gmail.com', 2, '', '', '', '', 0, 0, 0, '', '', '', 0, 0, 0, '', '', 0, 0, 0, 583, 764, 755, 598, 312, 77, '', '', '', '540', '', '', 0, '', '', 0, 1, '0000-01-01', '0000-01-01', '', '0000-01-01', '0000-01-01', '', '0000-01-01', '', '0000-01-01', '', '0000-01-01', 0, '0000-01-01', '2021-03-05 20:00:00', '', '', '', '', '', '', '', '', '', '', 1, 312, '2021-03-05 19:59:43', NULL, NULL, NULL),
(6, 'L202136', 'Subuj', 'Poddar', '', '', '880', '1716552200', NULL, '880', '', 'sobuz@gmail.com', 2, '', '', '', '', 0, 0, 0, '', '', '', 0, 0, 0, '', '', 0, 0, 0, 583, 758, 746, 597, 305, 73, '', '', '', '615', '', '', 0, '', '', 0, 1, '0000-01-01', '0000-01-01', '', '0000-01-01', '0000-01-01', '', '0000-01-01', '', '0000-01-01', '', '0000-01-01', 0, '0000-01-01', '2021-03-05 23:45:00', '', '', '', '', '', '', '', '', '', '', 1, 305, '2021-03-05 23:44:32', NULL, '2021-03-06', NULL);
...
(19, 3, 'Meeting with TL/HOD', 2, 2, 1, 0, NULL, 0, NULL),
(20, 3, 'Have Interest for Product of UNIMASS', 1, 3, 1, 0, NULL, 0, NULL),
...
--
-- Dumping data for table `t_leadtransfer`
--

INSERT INTO `t_leadtransfer` (`transfer_pk_no`, `lead_transfer_id`, `transfer_datetime`, `lead_pk_no`, `transfer_from_sales_agent_pk_no`, `transfer_to_sales_agent_pk_no`, `transfer_to_sales_agent_flag`, `re_transfer`, `is_rejected`, `c_pk_no_created`, `ch_user_pk_no`, `created_by`, `created_at`, `updated_by`, `updated_at`, `c_pk_no_updated`) VALUES
(1, '1', '2021-03-05', 1, 310, 312, 1, 1, NULL, 1, 305, 310, '2021-03-05', NULL, '2021-03-05', NULL),
(2, '1', '2021-03-05', 5, 305, 310, 1, 1, NULL, 1, 305, 305, '2021-03-05', NULL, NULL, NULL),
(3, '1', '2021-03-06', 6, 305, 310, 1, 0, NULL, 1, 305, 305, '2021-03-06', NULL, NULL, NULL),
(4, '1', '2021-03-06', 6, 305, 310, 1, 1, NULL, 1, 305, 305, '2021-03-06', NULL, NULL, NULL),
(5, '1', '2021-03-10', 3, 305, 311, 1, 1, NULL, 1, 305, 305, '2021-03-10', NULL, NULL, NULL);
...
--
-- Dumping data for table `t_leadtransferhistory`
--

INSERT INTO `t_leadtransferhistory` (`transhistory_pk_no`, `lead_pk_no`, `project_category_pk_no`, `project_area_pk_no`, `Project_pk_no`, `project_size_pk_no`, `transfer_from_sales_agent_pk_no`, `transfer_to_sales_agent_pk_no`, `is_rejected`, `ch_user_no_pk`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES
(1, 1, 583, 758, 746, 597, 310, 312, NULL, 305, NULL, '2021-03-05', NULL, '2021-03-05'),
(2, 5, 583, 764, 755, 598, 312, 310, NULL, 305, NULL, '2021-03-05', NULL, '2021-03-05'),
(3, 6, 583, 758, 746, 598, 310, 310, NULL, 305, NULL, '2021-03-06', NULL, '2021-03-06'),
(4, 6, 583, 758, 746, 597, 310, 310, NULL, 305, NULL, '2021-03-06', NULL, '2021-03-06'),
(5, 3, 583, 555, 749, 599, 311, 311, NULL, 305, NULL, '2021-03-10', NULL, '2021-03-10');
...
(17, '1', 782, 305, 583, '0', 1, 0, 0, 305, 0, 309, 2, 1, 15, '2021-03-05', 0, '2021-03-05', 0, NULL, NULL),
(18, '1', 782, 309, 583, '0', 0, 0, 1, 305, 0, 309, 2, 1, 15, '2021-03-05', 0, '2021-03-05', 0, NULL, NULL),
(19, '1', 782, 310, 583, '0', 0, 0, 0, 305, 0, 309, 2, 1, 15, '2021-03-05', 0, '2021-03-05', 0, NULL, NULL),
(20, '1', 782, 311, 583, '0', 0, 0, 0, 305, 0, 309, 2, 1, 15, '2021-03-05', 0, '2021-03-05', 0, NULL, NULL),
(21, '1', 782, 312, 583, '0', 0, 0, 0, 305, 0, 309, 2, 1, 15, '2021-03-05', 0, '2021-03-05', 0, NULL, NULL),
(22, '1', 782, 313, 583, '0', 0, 0, 0, 305, 0, 309, 2, 1, 15, '2021-03-05', 0, '2021-03-05', 0, NULL, NULL);
...
(24, 'NEXTGENiT Super Amin', '1', 0, 'admin@app.com', '01882348340', NULL, NULL, NULL, 1, '$2y$10$rhM4b9sjMzu8jPPdnJYkIeA6A0VduJdjevff4U3JZVLg/gS4dyNTu', 'ezYIyszfn1shBTxIXJMBT1ZCIHJ6qDTGFylNudollws8HBAdjIAlSWfr71Gz', 1, '2020-01-04 07:24:42', '2021-01-06 04:19:31', NULL),
...
(338, 'CSD', '775', 3, 'csd@app.com', '015285287587', NULL, NULL, NULL, NULL, '$2y$10$cr3fDt/R7zpfsw7hWayoqOziAAaiPu5Tn5YwVr.nJxL/TVEp7x/ni', NULL, 1, '2021-02-28 10:54:07', '2021-02-28 10:54:07', NULL);
...
--
-- Indexes for table `schedule_followup`
--
ALTER TABLE `schedule_followup`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `schedule_followup`
--
ALTER TABLE `schedule_followup`
...
--
ALTER TABLE `s_lookdata`
  MODIFY `lookup_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=789;

--
-- AUTO_INCREMENT for table `s_pages`
--
ALTER TABLE `s_pages`
  MODIFY `page_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `s_projectwiseflatlist`
--
ALTER TABLE `s_projectwiseflatlist`
  MODIFY `flatlist_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `s_rbac`
--
ALTER TABLE `s_rbac`
  MODIFY `rbac_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
...
--
ALTER TABLE `s_user`
  MODIFY `user_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=316;
...
--
ALTER TABLE `t_leadfollowup`
  MODIFY `lead_followup_pk_no` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `t_leadlifecycle`
  MODIFY `leadlifecycle_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `t_leads`
--
ALTER TABLE `t_leads`
  MODIFY `lead_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `t_leadtransfer`
  MODIFY `transfer_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `t_leadtransferhistory`
--
ALTER TABLE `t_leadtransferhistory`
  MODIFY `transhistory_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `t_teambuild`
--
ALTER TABLE `t_teambuild`
  MODIFY `teammem_pk_no` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
