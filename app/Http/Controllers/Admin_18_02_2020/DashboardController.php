...
class DashboardController extends Controller
{
	public function index($other_user_id=null)
	{
		...
		return view('admin.dashboard',compact('lead_count','k1','priority','sold','hold','closed','transferred','accepted','avt_data','apt_data','acr_data','next_followup','missed_followup','cre_lead_count'));
	}
