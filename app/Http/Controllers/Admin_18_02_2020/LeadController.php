...
class LeadController extends Controller
{
    ...
    public function check_if_phone_no_exist(Request $request)
    {
    	...
    	->Join('s_lookdata', 's_user.role_lookup_pk_no', '=', 's_lookdata.lookup_pk_no')
    	...
    	for ($i = 0; $i < count($leadArr); $i ++)
    	{
    		...
    		if($lead_mst_id!="")
    		{
    			...
    			if($current_stage!='Lead' && $lead_followup_date != "")
    			{
    				...
    				[
    					'lead_pk_no' => $lead_mst_id,
    					'lead_followup_datetime' => ($lead_followup_date!='')?$lead_followup_date:NULL,
    					...
    					'Next_FollowUp_date' => ($lead_followup_date!='')?$lead_followup_date:NULL,
