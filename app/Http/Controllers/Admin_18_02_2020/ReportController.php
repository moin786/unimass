...
class ReportController extends Controller
{
	...
	public function export_report(Request $request)
	{
		...
		$columns = array("Customer First Name","Customer Last Name","Country Code1","Phone Number 1","Country Code2","Phone Number 2","Email","Occupation","Organization","Category","Area","Project Name","Size","Sub Source Name","Digital Marketing","Emp ID","Name","Position","Contact Number","SAC Name","SAC Note","Hotline","Customer DOB","Marriage Anniversary","Wife Name","Wife DOB","Children Name1","Children DOB1","Children Name2","Children DOB2","Children Name3","Children DOB3");
