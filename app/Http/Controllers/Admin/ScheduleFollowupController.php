...
class ScheduleFollowupController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		$schedule_followup->followup_date = date("Y-m-d");
		$schedule_followup->followup_time = date("Y-m-d H:i:s");
		$schedule_followup->next_followup_date = $txt_followup_date;
		$schedule_followup->next_followup_time = $txt_followup_date_time;
		$schedule_followup->visit_date = $meeting_followup_date;
		$schedule_followup->visit_date_time = $meeting_followup_date_time;
