...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2021 at 02:22 PM
...
--
-- Table structure for table `sold_project_schedlue`
--

CREATE TABLE `sold_project_schedlue` (
  `id` int(10) NOT NULL,
  ...
  `percent_of_total_apt_price` int(10) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `sold_project_schedlue`
--

INSERT INTO `sold_project_schedlue` (`id`, `lead_pk_no`, `lead_id`, `schedule_date`, `installment`, `amount`, `percent_of_total_apt_price`, `created_at`, `updated_at`) VALUES
(1, 2, NULL, '2021-02-02', '1st Istallment', 6340000.00, 40, '2021-02-24 14:01:01', '2021-02-24 14:01:01'),
(2, 2, NULL, '2021-02-18', '2nd Istallment', 1358571.00, 9, '2021-02-24 14:01:01', '2021-02-24 14:01:01'),
(3, 2, NULL, '2021-02-10', '2th installment', 1358571.00, 9, '2021-02-24 14:01:01', '2021-02-24 14:01:01'),
(4, 2, NULL, '2021-02-17', '3rd installment', 1358571.00, 9, '2021-02-24 14:01:01', '2021-02-24 14:01:01'),
(5, 2, NULL, '2021-02-26', '4th installment', 1358571.00, 9, '2021-02-24 14:01:01', '2021-02-24 14:01:01'),
(6, 2, NULL, '2021-02-24', '5th installment', 1358571.00, 9, '2021-02-24 14:01:01', '2021-02-24 14:01:01'),
(7, 2, NULL, '2021-02-15', '6th installment', 1358571.00, 9, '2021-02-24 14:01:01', '2021-02-24 14:01:01'),
(8, 2, NULL, '2021-02-20', '7th installment', 1358571.00, 9, '2021-02-24 14:01:01', '2021-02-24 14:01:01');
...
(24, 'NEXTGENiT Super Amin', '1', 0, 'admin@app.com', '01882348340', NULL, NULL, NULL, 1, '$2y$10$rhM4b9sjMzu8jPPdnJYkIeA6A0VduJdjevff4U3JZVLg/gS4dyNTu', 'zmihSK5KKp58p0dvfirpwSgKkeyBh4GzlVWyR1LVkbTvDcw4ozZ2hkLAHN7u', 1, '2020-01-04 07:24:42', '2021-01-06 04:19:31', NULL),
...
--
-- Indexes for table `sold_project_schedlue`
--
ALTER TABLE `sold_project_schedlue`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `sold_project_schedlue`
--
ALTER TABLE `sold_project_schedlue`
