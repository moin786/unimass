		...
		<div class="col-xs-12">
			<div class="nav-tabs-custom">
				...
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="#manual_lead" data-toggle="tab" data-type="1" data-action="load_junk_leads" aria-expanded="true">Pending</a></li>
					<li class=""><a href="#pending_lead" data-toggle="tab" data-type="0" data-action="load_junk_leads" aria-expanded="false">Completed</a></li>
				</ul>
				@endif

				<div class="tab-content">
					@include("admin.lead_management.junk_lead.junk_work_list_data")
				</div>
			</div>
		...
		$('.select2').select2();
            ...
            $(document).on("click", ".distribute-lead", function(e){
            	if(confirm("Are You Sure?"))
            	{
            		...
            		var formData = $("#junk-distribute-form").serialize();
