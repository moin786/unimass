			...
			<tr>
				...
				<td class="text-center w-50 border-0">
					<div class="information mb-15">
						...
						<div class="report_name">CUSTOMER ACCOUNT</div>
					</div>
				</td>
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						...
						<td>42,43, Dilu Road, Eskaton, Dhaka</td>
					</tr>
			...
			<table class="table table-borderless">
				<thead class="bg-light-theme">
					<tr>
						...
						<th class="text-right">Amount in Taka</th>
				...
				<tbody>
					<tr>
						<th class="text-left">Apartment Price</th>
						<td class="text-right"></td>
						<td class="text-right"></td>
						<td class="text-right"></td>
					</tr>
					<tr>
						<th class="text-left">Car Parking</th>
						<td class="text-right"></td>
						<td class="text-right"></td>
						<td class="text-right"></td>
					</tr>
					<tr>
						<th class="text-left">Utility Charges</th>
						<td class="text-right"></td>
						<td class="text-right"></td>
						<td class="text-right"></td>
					</tr>
					<tr>
						<th class="text-left">Reserve Fund</th>
						<td class="text-right"></td>
						<td class="text-right"></td>
						<td class="text-right"></td>
					</tr>
			...
			<table class="w-100">
				<thead class="bg-light-theme">
					<tr>
						...
						<th class="text-left">Description of Payment</th>
						...
						<th class="text-right">Installment Due Amount</th>
						<th class="text-right">Received Tk.</th>
						<th class="text-right">Adjustment Tk.</th>
						<th class="text-right">Balance</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td class="font-weight-normal text-center">On / Before 23rd December 2018</td>
				...
				<tfoot class="bg-light-theme">
					...
					<tr>
						<th colspan="7">Receivable Overdues</th>
						<th class="text-right">0.00</th>
					...
					<tr>
						<th colspan="7">Receivable Notyet Dues</th>
						<th class="text-right">0.00</th>
						<th class="text-right"></th>
						<th class="text-right"></th>
						<th class="text-right"></th>
					...
					<tr>
						<th colspan="7">Receivable against R/Fund</th>
						<th class="text-right">0.00</th>
						<th class="text-right"></th>
						<th class="text-right"></th>
						<th class="text-right"></th>
