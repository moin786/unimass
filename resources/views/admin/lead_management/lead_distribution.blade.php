		...
		<div class="col-xs-12">
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="#manual_lead" data-toggle="tab" data-type="1" data-action="load_dist_leads_to_ch" aria-expanded="true">Pending</a></li>
                    <li class=""><a href="#pending_lead" data-toggle="tab" data-type="0" data-action="load_dist_leads_to_ch" aria-expanded="false">Completed</a></li>
