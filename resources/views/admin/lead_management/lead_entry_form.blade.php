									...
									<div class="form-group form-row">
										...
										<div class="col-xs-4">
											<select class="form-control select2" name="country_code1" aria-hidden="true">
												...
												<option value="{{ $country->phonecode }}" {{ ($country->iso=='BD')? 'selected':'' }} >{{ $country->name ." (". $country->phonecode.")" }}
												</option>
												@endforeach
												@endif
											</select>
						...
						<div class="form-row">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<select class="form-control" id="txt_present_area" name="txt_present_area" title="Select Area">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<select class="form-control select2" id="txt_present_district" name="txt_present_district" placeholder="Organization">
						...
						<div class="form-row">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control select2" id="txt_parmanent_district" name="txt_parmanent_district" title="District">
										<option value="0">Select District</option>
										@if(!empty($district))
										@foreach ($district as $value)
										<option value="{{ $value->id }}">{{ $value->district_name }}</option>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control select2" id="txt_parmanent_thana" name="txt_parmanent_thana" title="Thana">
										<option value="0">Select Thana</option>
										@if(!empty($thana))
										@foreach ($thana as $value)
										<option value="{{ $value->id }}">{{ $value->thana_name }}</option>
						...
						<div class="form-row">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<select class="form-control" id="txt_organization_area" name="txt_organization_area" title="" placeholder="Organization">
										<option value="0">Select Area</option>
										@if(!empty($area))
										@foreach ($area as $key => $value)
										<option value="{{ $key }}">{{ $value }}</option>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control select2" id="txt_organization_district" name="txt_organization_district" title="">
										<option value="0">Select District</option>
										@if(!empty($district))
										@foreach ($district as $value)
										<option value="{{ $value->id }}">{{ $value->district_name }}</option>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="form-control select2" id="txt_organization_thana" name="txt_organization_thana" title="">
										<option value="0">Select Thana</option>
										@if(!empty($thana))
										@foreach ($thana as $value)
										<option value="{{ $value->id }}">{{ $value->thana_name }}</option>
					...
					<div class="form-row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select class="form-control select2 required" id="cmb_size" name="cmb_size" style="width: 100%;" aria-hidden="true">
						...
						<div class="form-group">
							<label style="cursor:pointer;">
								<div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
									...
									name="Source" class="flat-red" style="position: absolute; opacity: 0;">
							...
							<div class="form-row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control datepicker" id="txt_child_dob_1"name="txt_child_dob_1" title="" readonly="readonly" placeholder="dd-mm-yyyy"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control datepicker" id="txt_child_dob_2" name="txt_child_dob_2" title="" readonly="readonly" placeholder="dd-mm-yyyy"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control datepicker" id="txt_child_dob_3" name="txt_child_dob_3" title="" readonly="readonly" placeholder="dd-mm-yyyy"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" id="child_education" name="child_education" class="form-control " placeholder="Child Education"/>
									</div>
								</div>
							</div>
							...
							<div class="form-row">
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control " name="food_habit" id="food_habit" placeholder="Food Habit"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="political_opinion" id="political_opinion"placeholder="Political Opinion"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="color_preference" name="color_preference" placeholder="Color Preference"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="hobby" name="hobby" placeholder="Color Preference"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" id="traveling_history" name="traveling_history" class="form-control " placeholder="Traveling History"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" id="memberofclub" name="memberofclub" class="form-control " placeholder="Member of Club"/>
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="disease_name" id="disease_name" placeholder="Disease"/>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="form-row">
						...
						<div class="col-md-12">
							<div class="form-check">
								<label style="cursor:pointer;">
									<div class="iradio_flat-green" aria-checked="false" aria-disabled="false" style="position: relative; margin-right:10px; margin-bottom:6px;">
										<input type="radio" id="Sub_Source" value="{{ $key }}" name="Sub_Source[]" class="flat-red" style="position: absolute; opacity: 0;" required>
