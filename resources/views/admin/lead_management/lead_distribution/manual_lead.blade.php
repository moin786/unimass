<div class="tab-pane table-responsive" id="manual_lead">
			...
			<tr>
				...
				<td class="text-center">
					<span class="btn bg-info btn-xs lead-view" title="View Lead Details" data-id="{{ $row->lead_pk_no }}"
						...
						data-target="#manual_lead"
						data-id="{{ $row->leadlifecycle_pk_no }}"
						data-action="{{ route('distribute_lead',$row->leadlifecycle_pk_no) }}"><i class="fa fa-save"></i>
					</span>
				</td>
			</tr>
			@endif
