...
<section id="search_details" class="content_text" style="padding-bottom: 0px;">
	<div class="row">
		<div class="col-xs-12">
			<form action="{{ route('export_report_stage_wise') }}" id="frmSearch" method="post" >
				{{ csrf_field() }}
								...
								<div class="form-group">
									...
									<select class="form-control" name="report_type" id="report_type">
										...
										@if(!empty($lead_source))
											@foreach($lead_source as $ld_source)
											<option value="{{ $ld_source->lookup_id }}">{{ $ld_source->lookup_name }}</option>
											@endforeach
										@endif
...
<section class="content">
	<div class="row">
		<div class="col-xs-12" id="search_result_con">
			@include("admin.report_module.stage_wise_user_report_result")
		</div>
	</div>
</section>
<!-- /.content -->
