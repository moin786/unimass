...
@section('content')
    ...
    <section class="content-header">
        <h1>Monthly Lead Report</h1>

        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Report Module</a></li>
            <li class="active">Monthly Lead Report</li>
        </ol>
    </section>
    ...
    <section id="search_details" class="content_text" style="padding-bottom: 0px;">
        <div class="row">
            <div class="col-xs-12">
                <form action="{{ route('export_monthly_lead_report') }}" id="frmSearch" method="post">
                    {{ csrf_field() }}
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12" id="search_result_con">
                @include("admin.report_module.monthly_lead_report_result")
            </div>
        </div>
    </section>
    <!-- /.content -->
        ...
        $(function () {
            ...
            $(document).on("click", "#btnSearchReport", function (e) {
                ...
                $.ajax({
                    ...
                    url: 'monthly_lead_report_result',
                    type: 'post',
                    beforeSend: function () {
                        $.blockUI({
