        ...
        <div class="info-box">
            ...
            <a href="{{ $hp_link }}" class="small-box-footer">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ isset($sold[0]->total_lead) ? $sold[0]->total_lead : 0 }}</span>
                </div>
            </a>
        </div>
    </div>
        ...
        <div class="info-box">
            ...
            <a href="{{ $hp_link }}" class="small-box-footer">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ isset($hold[0]->total_lead) ? $hold[0]->total_lead : 0 }}</span>
                </div>
            </a>
        </div>
    </div>
        ...
        <section class="col-lg-4 connectedSortable">
                    ...
                    <table class="table table-bordered table-striped dataTable m-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="{{ route('stage_wise_lead_list', 1) }}" class="routeSetUp">
                                        ...
                                        @if ($mql->lead_count == 0)
                                            <small
                                                class="label label-default pull-right">{{ $mql->lead_count }}</small>
                                        @else
                                            <small
                                                class="label label-success pull-right">{{ $mql->lead_count }}</small>
                                        @endif
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('stage_wise_lead_list', 3) }}" class="routeSetUp">
                                        ...
                                        @if ($sgl->lead_count == 0)
                                            <small
                                                class="label label-default pull-right">{{ $sgl->lead_count }}</small>
                                        @else
                                            <small
                                                class="label label-success pull-right">{{ $sgl->lead_count }}</small>
                                        @endif
                                    </a>
                                </td>
                            </tr>
                            @if ($role_id == 77)
                                <tr>
                                    <td>
                                        <a href="{{ route('my_lead_list') }}" class="routeSetUp"> <span
                                                class="handle">
                                                <i class="fa fa-ellipsis-v"></i>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('todays_visit_lead') }}" class="routeSetUp"> <span
                                            class="handle">
                                            <i class="fa fa-ellipsis-v"></i>
                                            <i class="fa fa-ellipsis-v"></i></span>
                                        ...
                                        @if ($meeting_count == 0)
                                            <small
                                                class="label label-default pull-right">{{ $meeting_count }}</small>
                                        @else
                                            <small
                                                class="label label-success pull-right">{{ $meeting_count }}</small>
                                        @endif
                                    </a>
                                </td>
                            </tr>
            ...
            {{-- <table class="table table-bordered table-striped dataTable m-0">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <a href="{{ route('junk_work_list', 2) }}" class="routeSetUp">
                                        ...
                                        @if ($junk_walkin[0]->total_lead == 0)
                                            <small
                                                class="label label-default pull-right">{{ isset($junk_walkin[0]->total_lead) ? $junk_walkin[0]->total_lead : 0 }}</small>
                                        @else
                                            <small
                                                class="label label-success pull-right">{{ isset($junk_walkin[0]->total_lead) ? $junk_walkin[0]->total_lead : 0 }}</small>
                                        @endif
                                    </a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('junk_work_list', 3) }}" class="routeSetUp"> <span
                                            class="handle">
                                            <i class="fa fa-ellipsis-v"></i>
                                            <i class="fa fa-ellipsis-v"></i></span>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="routeSetUp">
                                                    ...
                                                    @if ($project_count == 0)
                                                        <small
                                                            class="label label-default pull-right">{{ $project_count }}</small>
                                                    @else
                                                        <small
                                                            class="label label-success pull-right">{{ $project_count }}</small>
                                                    @endif
                        ...
                        @foreach ($source_wise_count_arr as $data => $value)
                            <li>
                                <a href="#"> <span class="handle">
                                    ...
                                    @if ($value == 0)
                                        <small class="label label-default pull-right">{{ $value }}</small>
                                </a>
                            @else
                ...
                @if ($user_type == 2 || $is_super_admin == 1)
                    <li>
                        <a href="{{ route('all_lead') }}" class="routeSetUp"> <span class="handle">
                            ...
                            @if ($all_lead_count == 0)
                                <small class="label label-default pull-right">{{ $all_lead_count }}</small>
                            @else
                                <small class="label label-success pull-right">{{ $all_lead_count }}</small>
                            @endif
                    ...
                    @if ($is_super_admin != 1)
                        <li>
                            <a href="{{ route('lead_follow_up_data', 1) }}" class="routeSetUp">
                                <span class="handle"><i class="fa fa-ellipsis-v"></i><i class="fa fa-ellipsis-v"></i>
                                </span>
                                <span class="text">Today Followup</span>
                                @if ($today_followup == 0)
                                    <small class="label label-default pull-right">{{ $today_followup }}</small>
                                @else
                                    <small class="label label-success pull-right">{{ $today_followup }}</small>
                                @endif
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('lead_follow_up_data', 3) }}"> <span class="handle">
                                    <i class="fa fa-ellipsis-v"></i>
                                    <i class="fa fa-ellipsis-v"></i>
                                </span>
                                <span class="text">Next Followup</span>
                                @if ($next_followup == 0)
                                    <small class="label label-default pull-right">{{ $next_followup }}</small>
                                @else
                                    <small class="label label-success pull-right">{{ $next_followup }}</small>
                                @endif
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('lead_follow_up_data', 2) }}"> <span class="handle">
                                    <i class="fa fa-ellipsis-v"></i>
                                    <i class="fa fa-ellipsis-v"></i>
                                </span>
                                <span class="text">Missed Followup</span>
                                @if ($missed_followup == 0)
                                    <small class="label label-default pull-right">{{ $missed_followup }}</small>
                                @else
                                    <small class="label label-success pull-right">{{ $missed_followup }}</small>
                                @endif
                            </a>
                        </li>
                        <li>
