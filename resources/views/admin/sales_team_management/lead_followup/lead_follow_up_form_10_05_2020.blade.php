<form id="frmLeadFollowup" action="{{ route('lead_follow_up.store') }}" method="post">
	...
	<div class="form-group">
		...
		<textarea class="form-control" style="height: auto !important;" rows="3" id="followup_note" name="followup_note" title="Note"
	...
	<div>
		...
		<div class="form-group">
			...
			<textarea class="form-control" rows="3" style="height: auto !important;" id="next_followup_note" name="next_followup_note"
