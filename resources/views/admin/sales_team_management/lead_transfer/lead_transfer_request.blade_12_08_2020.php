        ...
        <table id="lead_transfer_request" class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
                    ...
                    <th style=" min-width: 20px" class="text-center"><a href="#" class="btn bg-blue btn-block btn-xs btn-accept-request" data-response-action="{{ route('load_transfer_leads') }}">Accept</a></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $row->lead_sales_agent_name }}</td>
                    <td class="text-center">{{ $followup_arr[$row->lead_pk_no]['lead_followup_datetime'] }}</td>
                    <td class="text-center">{{ $followup_arr[$row->lead_pk_no]['followup_Note'] }}</td>
                    <td class="text-center">{{ $followup_arr[$row->lead_pk_no]['Next_FollowUp_date'] }}</td>
